...
Shows unique ad copies Semrush noticed when the domain ranked in Google's paid search results for keywords from Semrush databases.
...
|---|---|---|
| `type` | Yes | Report type. Value: `domain_adwords_unique` |
