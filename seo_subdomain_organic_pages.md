# SEO API — Subdomain Organic Pages

**Price:** 10 API units per line
**Price (historical data):** 50 API units per line

Shows unique pages of the analyzed subdomain ranking in Google's top 100 organic search results.
...
|---|---|---|
| `type` | Yes | Report type. Value: `subdomain_organic_unique` |
...
```
https://api.semrush.com/?type=subdomain_organic_unique&key=API_KEY&display_filter=%2B%7CPc%7CGt%7C100&display_limit=10&export_columns=Ur,Pc,Tg,Tr&subdomain=tools.seobook.com&display_sort=tr_desc&database=us
```
...
"http://tools.seobook.com/firefox/rank-checker/","129","7","3.00"
```
