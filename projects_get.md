# Projects API — Get Information About An Existing Project

**Price:** 100 API units per request

Returns information about a project, including its ID, project name, domain name, and activated tools.

## Endpoint

```
GET https://api.semrush.com/management/v1/projects/{id}
```
