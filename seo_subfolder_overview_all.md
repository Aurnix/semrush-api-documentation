# SEO API — Subfolder Overview (all databases)

**Price:** 10 API units per line
**Price (historical data):** 50 API units per line

Provides live or historical data on a subfolder's keyword rankings in both organic and paid search across all regional databases.
...
|---|---|---|
| `type` | Yes | Report type. Value: `subfolder_ranks` |
...
```
https://api.semrush.com/?key=API_KEY&type=subfolder_ranks&export_columns=Db,Or,Ot,Oc,Ad,At,Ac,Sh,Sv&subfolder=tools.seobook.com/general/&database=us
```
